...
HueBridge.prototype.heartbeatConfig = function (beat) {
  return this.request('get', '/config').then((obj) => {
    ...
    if (this.config.exposeBridge && this.obj.linkbutton !== old.obj.linkbutton) {
      if (this.config.linkbutton) {
        this.log.debug(
    ...
    if (this.config.exposeBridge && this.hk.link !== old.hk.link) {
      this.log(
    ...
    if (this.config.exposeBridge && this.hk.touchlink !== old.hk.touchlink) {
      this.log(
